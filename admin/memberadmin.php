  ...
  <table class="table"> 
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= $row->jenis ?></td>
        <td>
          <a role="button" class="btn btn-secondary" href="editmember.php?id=<?= $row->user_id ?>">edit</a>
          <a role="button" class="btn btn-danger" href="hapusmember.php?id=<?= $row->user_id ?>" style="text-decoration:none" onClick="return confirm('Apakah anda yakin ingin menghapus tersebut??')">hapus</a>
