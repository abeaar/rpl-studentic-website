    ...
    <div class="d-flex justify-content-center p-4" style="border: 4px solid #D0D4CA; border-radius: 12px; background-color: white;">
      <div>
        <h1 class="text-center mb-5"><b>Edit Data</b></h1>
          <form action="proseseditmember.php?id=<?=$user_id?>" method="POST" class="">
            <table class="d-flex" style="width: 70vh">
              <tr class="d-flex gap-5 fs-4 mb-3" style="width: 70vh;">
                <td class="w-50 fs-5">Username:</td>
                <td class="w-100">
                  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Masukan nama" name="username" value="<?php echo $data['username']; ?>">
                </td>
              </tr>
              
              <tr class="d-flex gap-5 fs-4 mb-3">
                <td class="w-50 fs-5">Password:</td>
                <td class="w-100">
                  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Masukan password" name="password" value="<?php echo $data['password']; ?>">
                </td>
              </tr>

              <tr class="d-flex gap-5 fs-4 mb-3">
                <td class="w-50 fs-5">address:</td>
                <td class="w-100">
                  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Masukan alamat" name="address" value="<?php echo $data['address']; ?>">
                </td>
              </tr>

              <tr class="d-flex gap-5 fs-4 mb-3">
                <td class="w-50 fs-5">status:</td>
                <td class="w-100">
                  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Status" name="jenis" value="<?php echo $data['jenis']; ?>">
                </td>
              </tr>
