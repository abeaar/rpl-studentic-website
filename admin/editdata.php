          ...
          <form action="prosesedit.php?id=<?=$id_product?>" method="POST" class="">
            <table class="d-flex" style="width: 70vh">
              <tr class="d-flex gap-5 fs-4 mb-3" style="width: 70vh;">
                ...
                <td class="w-100">
                  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Masukan nama" name="name" value="<?php echo $data['name']; ?>">
                </td>
              </tr>
              ...
              <tr class="d-flex gap-5 fs-4 mb-3">
                ...
                <td class="w-100">
                  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="desc"><?php echo $data['product_description']; ?></textarea>
                </td>
              </tr>
            </table>
